    ...
    <div>
        <el-form label-width="100px">
            <el-form-item label="SPU名称">
                <el-input v-model="SpuParams.spuName" placeholder="请输入 SPU 名称"></el-input>
            </el-form-item>
            ...
            <el-form-item label="SPU描述">
                <el-input type="textarea" v-model="SpuParams.description" placeholder="描述"></el-input>
            </el-form-item>
            ...
            <el-form-item label="SPU销售属性">
                ...
                <el-table border style="margin: 10px 0" :data="saleAttr">
                    ...
                    <el-table-column label="销售属性名称" prop="saleAttrName"></el-table-column>

                    <el-table-column label="销售属值">
                        <template #="{ row }">
                            ...
                            <el-input v-if="row.flag == true" @blur="toLook(row)" v-model="row.saleAttrValue"
                                style="width: 100px" size="small" placeholder="请你输入属性值"></el-input>

                            <el-button @click="toEdit(row)" type="primary" size="small" icon="Plus" v-else></el-button>
                        </template>
                    </el-table-column>
