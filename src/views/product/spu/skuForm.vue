    ...
    <div>
        <el-form label-width="100px">
            ...
            <el-form-item label="价格(元)">
                <el-input type="number" clearable v-model="skuParams.price" placeholder="价格(元)"></el-input>
            </el-form-item>

            <el-form-item label="重量(元)">
                <el-input v-model="skuParams.weight" placeholder="重量(元)"></el-input>
            </el-form-item>

            <el-form-item label="SKU描述">
                <el-input type="textarea" clearable v-model="skuParams.skuDesc" placeholder="SKU描述"></el-input>
            </el-form-item>

            <el-form-item class="platAttr" label="平台属性">
                <div class="platAttrItem" v-for="(item, index) in attrArr">
                    <p class="itemTitle">{{ item.attrName }}</p>
                    <el-select class="itemSelect" v-model="item.attrIdAndValueId">
                ...
                <el-form :inline="true">
                    <el-form-item v-for="(item, index) in saleArr" :label="item.saleAttrName" :key="item.id">
                        <el-select v-model="item.saleIdAndValueId">
                            <el-option v-for="(saleAttrValue, index) in item.spuSaleAttrValueList"
